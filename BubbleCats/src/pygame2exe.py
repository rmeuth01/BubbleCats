...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "BubbleCats.py"

        #Name of program
        self.project_name = "BubbleCats"
        ...
        self.license = "OpenSource"

        #Auhor of program
        self.author_name = "Ryan Meuth"
        self.author_email = "rmeuth@gmail.com"
        self.copyright = "Copyright (c) 2009 Me."

        #Description
        self.project_description = "BubbleCats"
